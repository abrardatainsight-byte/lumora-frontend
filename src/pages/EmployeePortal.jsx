          ...
          <div style={{ textAlign: "center", maxWidth: 560 }}>
            ...
            {cameraStatus === "ready" && (
              <div style={{ marginTop: 24 }}>
                <button onClick={captureAndSend} style={{ padding: "10px 20px", background: "#fff", border: "1px solid #E2E8F0", borderRadius: 10, cursor: "pointer", fontSize: 13, color: "#475569", fontWeight: 600, boxShadow: "0 1px 3px rgba(0,0,0,.05)" }}>
